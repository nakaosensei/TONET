...
def runTest(model, adversarialDatasetPath,adversarialLabelsPath):    
    results = ''
...
if __name__=='__main__':    
    ...
    adversarialDatasetPath = '../outputs/stochasticAdversarialExamples/'
    adversarialLabelsPath = '../outputs/stochasticTargets/'
    #Testa o modelo com base nos arquivos em featuresPath e targetsPath
    runTest(model,adversarialDatasetPath,adversarialLabelsPath)
